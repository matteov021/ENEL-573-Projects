...
tau = 250 * 0.001                   # One-way propagation delay 250ms
delta = 5 * tau                     # ACK timeout (5x propagation delay)
...
def main():
    ...
    print(f"Successfully Transmitted Frames = {Num_received_frames} frames")
    print(f"Total Simulation Time = {Total_simu_time:.2f} s")
